...
4. **jsign** — install via Scoop or Chocolatey:
   ...
   Alternatively, download the all-in-one JAR from https://github.com/ebourg/jsign/releases and run with `java -jar jsign.jar`.
